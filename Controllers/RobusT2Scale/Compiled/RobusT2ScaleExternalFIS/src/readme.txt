...
-RobusT2ScaleExternalFIS.dll
   -contains the generated component using MWArray API. 
-RobusT2ScaleExternalFISNative.dll
...
RobusT2ScaleExternalFIS_overview.html - HTML overview documentation file for the 
...
RobusT2ScaleExternalFIS.xml - This file contains the code comments for the 
                                        RobusT2ScaleExternalFIS component classes and 
                                        ...
                                        documentation for the RobusT2ScaleExternalFIS 
                                        component.
